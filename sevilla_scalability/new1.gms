...
* ============================================================
$include "C:\Users\freal\MATLAB\Projects\untitled\code\sevilla_sizes\new2.gms";
...
pax_def..
    pax =e=
      1e-3*sum((o,d),
            demand(o,d)
          * sum((i,j), (4*prices(i,j))*fij(i,j,o,d)))
    + 1e-3*sum((o,d), demand(o,d)
          * (4*alt_price(o,d))*fext(o,d))
...
* Objetivo total
obj_def..
    obj =e= 1e-3*(alfa*pax+beta*bud+(1-alfa)*op);
